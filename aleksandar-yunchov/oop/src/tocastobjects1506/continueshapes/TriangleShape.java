...
public class TriangleShape extends Shape
{
  ...
  public TriangleShape(double aSide, double bSide, double gammaAngle)
  {
    this.aSide = aSide;
    this.bSide = bSide;
  ...
  public boolean checkTriangleObtuse(){
    if (this.alphaAngle != 90 && this.betaAngle != 90 && this.gammaAngle != 90 &&
        (this.alphaAngle > 90 || this.betaAngle > 90 || this.gammaAngle > 90)){
      return true;
    }
    return false;
  }
